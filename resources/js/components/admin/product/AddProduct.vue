    ...
    <form @submit.prevent="saveProduct">
      <a-row :gutter="16">
        <a-col :span="12">
          <div class="mb-4">
            <label class="block">{{
              translations.select_category || "Select Category"
            }}</label>
            <a-tree-select
      ...
      <a-row :gutter="16">
        <a-col :span="12">
          <div class="mb-4">
            <label class="block">{{
              translations.enter_product_name || "Enter Product Name"
            }}</label>
            <a-input
      ...
      <a-row :gutter="16">
        <a-col :span="12">
          <div class="mb-4">
            <label class="block">{{
              translations.enter_purchase_price || "Enter Purchase Price"
            }}</label>
            <a-input-number
        ...
        <a-col :span="12">
          <div class="mb-4">
            <label class="block">{{
              translations.enter_sale_price || "Sale Price"
            }}</label>
            <a-input-number
      ...
      <a-row :gutter="16">
        ...
        <a-col :span="12">
          <div class="mb-4">
            <label class="block">{{
              translations.select_status || "Select Status"
            }}</label>
            <a-select
      ...
      <div class="mb-4">
        <label class="block">{{
          translations.enter_description || "Enter Description"
        }}</label>
        <a-textarea
      ...
      <a-row :gutter="16">
        <a-col :span="12">
          <div class="mb-4">
            <label class="block">{{
              translations.thumbnail_image || "Thumbnail Image"
            }}</label>
            <input
              type="file"
        ...
        <a-col :span="12">
          <div class="mb-4">
            <label class="block">{{
              translations.gallery_images || "Gallery Images"
            }}</label>
            <input
              type="file"
              multiple
      ...
      <a-row :gutter="16">
        <a-col :xs="24" :md="12">
          <div class="mb-4">
            <label class="block">{{
              translations.enter_discount || "Enter Discount"
            }}</label>
            <a-input-number
        ...
        <a-col :xs="24" :md="12">
          <div class="mb-4">
            <label class="block font-bold">{{
              translations.final_price || "Final Price"
            }}</label>
            <a-input-number
